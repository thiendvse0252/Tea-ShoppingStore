    ...
    <body class="w3-content" style="max-width:1200px">
        ...
        <nav class="w3-sidebar w3-bar-block w3-white w3-collapse w3-top" style="z-index:3;width:250px" id="mySidebar">
            <div class="w3-container w3-display-container w3-padding-16">
                ...
                <h3 class="w3-wide"><b>IT'S MILK TEA TIME</b></h3>
            </div>
            <div class="w3-padding-64 w3-large w3-text-grey" style="font-weight:bold">
                <a href="#" class="w3-bar-item w3-button">Flavour</a>
                <a href="#" class="w3-bar-item w3-button">Healthy</a>
        ...
        <div class="w3-main" style="margin-left:250px">
            ...
            <div class="w3-display-container w3-container">
                <img src="https://media.istockphoto.com/photos/men-holding-beverage-drinks-ready-to-servecafe-stylegreen-tea-picture-id1182600783?k=20&m=1182600783&s=612x612&w=0&h=90sEJY4XaUWWZsdH4VFANnZZa4RJh8ackWGtmx3_X2A="
                     alt="Jeans" style="width:100%">
                <div class="w3-display-topleft w3-text-white" style="padding:24px 48px">
                    <h1 class="w3-jumbo w3-hide-small">New orders</h1>
                    <h1 class="w3-hide-large w3-hide-medium">New orders</h1>
            ...
            <footer class="w3-padding-64 w3-light-grey w3-small w3-center" id="footer">
                <div class="w3-row-padding">
                    ...
                    <div class="w3-col s4 w3-justify">
                        <h4>Store</h4>
                        <p><i class="fa fa-fw fa-map-marker"></i> Milk Tea Shop</p>
                        <p><i class="fa fa-fw fa-phone"></i> 0925788429</p>
                        <p><i class="fa fa-fw fa-envelope"></i> thien25078@gmail.com</p>
                        <h4>We accept</h4>
                        <p><i class="fa fa-fw fa-cc-amex"></i> Momo</p>
                        <p><i class="fa fa-fw fa-credit-card"></i> Credit Card</p>
                        <br>
                        <a href="https://www.facebook.com/Milk-Tea-47-110006340853812/"><i class="fa fa-facebook-official w3-hover-opacity w3-large"></i></a>
                        <a href="#"><i class="fa fa-instagram w3-hover-opacity w3-large"></i></a>
                        <a href="https://pin.it/3a3jsAJ"><i class="fa fa-pinterest-p w3-hover-opacity w3-large"></i></a>
