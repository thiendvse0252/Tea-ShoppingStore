...
<html>
    <head>
        ...
        <title>Login Page | Milk Tea 47</title>
    </head>
    <body>
    ...
    <center>
        <div>
            <a href="addUser.jsp" style="text-decoration: none; color: burlywood;">Create User</a>
        </div>
        <a href="home.jsp" style="text-decoration: none; color: burlywood;">Home</a>
    </center>
