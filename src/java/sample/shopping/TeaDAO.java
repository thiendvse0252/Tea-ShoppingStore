...
public class TeaDAO {
    ...
    public static List<Tea> getProductByID(String id) throws SQLException {
    ...
    public List<Tea> getAllProduct() throws SQLException {
        List<Tea> list = new ArrayList<>();
        Connection conn = null;
        PreparedStatement ptm = null;
        ResultSet rs = null;
        try {
            ...
            if (conn != null) {
                ...
                while (rs.next()) {
                    ...
                    list.add(new Tea(id, name, price, quantity, image, categoryID));
                }
            }
    ...
    public static Tea getTea(String ID) throws
        ...
        try {
            ...
            while (ReS.next()) {
                Tea acc = new Tea(ReS.getString(1), ReS.getString(2), ReS.getDouble(3), ReS.getInt(4), ReS.getString(5), ReS.getString(6));
                return acc;
